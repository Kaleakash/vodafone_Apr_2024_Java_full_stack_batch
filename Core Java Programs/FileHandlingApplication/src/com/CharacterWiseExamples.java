...
//		fw.write(ch);
//	}
//	fw.flush();		// this method is use to send the data from buffer to file 
//	System.out.println("Data stored");
		...
		BufferedReader br = new BufferedReader(isr);	// this class provide readLine method to read data. 
